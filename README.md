...
Just-in-time server and static site generator written in [Node.js](https://nodejs.org/). Rosid transform your files on-the-fly before serving them to the browser.
